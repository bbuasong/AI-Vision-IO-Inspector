...
namespace AI.Vision.IOInspector.Vision.Services
{
    ...
    public class MeasurementCalibrationService
    {
        ...
        public MeasurementCalibrationService(string applicationRootPath)
        {
            ...
            Load(ProjectDataRootResolver.Resolve(applicationRootPath));
        }
        ...
        private void Load(string projectDataRootPath)
        {
            string calibrationPath = Path.Combine(projectDataRootPath, "CFG", "Calibration.json");
