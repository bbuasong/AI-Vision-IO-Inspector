...
namespace AI.Vision.IOInspector.App.ViewModels
{
    ...
    public class CameraChannelStatusViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// 검사 화면 미리보기 전용 RTSP 주소입니다. 비워 두면 RtspUrl을 그대로 사용합니다.
        /// 검사 촬영에는 사용하지 않으므로 서브 스트림을 넣어도 검사 화질에는 영향이 없습니다.
        /// </summary>
        public string PreviewRtspUrl
        {
            get { return _previewRtspUrl; }
            set { SetProperty(ref _previewRtspUrl, value, "PreviewRtspUrl"); }
        }
        ...
        public CameraChannelConfig ToConfig()
        {
            ...
            config.PreviewRtspUrl = PreviewRtspUrl;
        ...
        public void ApplyStatus(CameraChannelStatus status)
        {
            ...
            PreviewRtspUrl = status.PreviewRtspUrl;
