...
namespace AI.Vision.IOInspector.Infrastructure.Services.Camera
{
    ...
    public class ConfiguredCameraService : ICameraService
    {
        ...
        ///
        /// <para>
        /// 이 메서드 자체는 여러 스레드가 함께 불러도 자료가 깨지지 않도록 만들어져 있습니다.
        /// 다만 <b>실제 호출은 상위에서 줄을 세웁니다</b>(VisionCameraCoordinator).
        /// NVR이 동시 RTSP 접속을 감당하지 못해, 6채널이 한꺼번에 붙으면
        /// 여러 채널이 같은 순간에 스트림을 받지 못하고 실패했기 때문입니다.
        /// </para>
        ///
        /// <para>
        /// 여기서 잠그는 것은 공유 자료(채널 목록, 상태 표)뿐입니다.
        /// 촬영 자체를 잠그지 않는 이유는, 상위의 줄 세우기 정책이 바뀌었을 때
        /// 이 클래스를 고치지 않아도 되게 하기 위함입니다.
        /// </para>
        /// </summary>
