...
67. 2026-06-09 - 문서 - Vision 담당자가 읽어야 할 README와 구현 체크리스트를 현재 상태 기준으로 다시 정리하고, 남은 항목을 외부 모델/보정/실장비 검증 항목으로 분리했습니다. (`AI.Vision.IOInspector.Vision/README.md`, `AI.Vision.IOInspector.Vision/Docs/vision-implementation-checklist.md`)
...
70. 2026-06-11 - 문서 - 기존 VLAD_Ops 대비 현재 구현 상태, 부족한 부분, 검사 시작 오류 원인을 Vision 담당자 문서로 정리했습니다. (`AI.Vision.IOInspector.Vision/Docs/vlad-ops-gap-analysis-2026-06-11.md`, `AI.Vision.IOInspector.Vision/Docs/README.md`, `AI.Vision.IOInspector.Vision/Docs/vision-implementation-checklist.md`)
...
72. 2026-06-11 - 문서 - 기존 VLAD_Ops의 RTSP/File/Event 이미지 저장 흐름과 현재 프로젝트의 `DB\Image` 기준 이미지, `DB\History` 검사 캡처, AI/DB 기준값 판정 흐름을 비교하고 판단 기준을 정리했습니다. (`AI.Vision.IOInspector.Vision/Docs/vlad-image-flow-decision-2026-06-11.md`, `AI.Vision.IOInspector.Vision/Docs/README.md`)
