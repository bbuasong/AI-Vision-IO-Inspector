...
| 파일 | 내용 |
| --- | --- |
| `architecture.md` | Application 레이어와 주요 모듈 구조 |
| `data-model.md` | DB 테이블 및 파일 저장 구조 초안 |
| `data-spec.md` | 구현 확인용 데이터 필드 명세 |
| `screen-map.md` | 화면 목록과 화면별 역할 |
| `ui-spec.md` | 화면별 표시 항목과 동작 명세 |
